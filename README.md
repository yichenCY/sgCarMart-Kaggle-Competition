...
Utilize the tree-based models, including XGBoost, LightGBM and CatBoost, to solve the first task which is to predict the resale price. We start with Feature engineering, followed by Model implementation and tunning, and end with evaluation.
